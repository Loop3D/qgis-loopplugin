...
from m2l_wrapper import M2l_Wrapper
...
async def handler(socket):
	...
	if not check_message_format_valid(package):
		...
		if package["function"] == "TEST":
			...
			output_data_map2model_path = './output_data/map2model_data'
			try:
				for folder_path in [source_data_path,output_data_path,output_data_map2model_path]:
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Map2Loop Server")
	parser.add_argument(
